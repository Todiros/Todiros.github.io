...
var getInput = function getInput() {
  var input = (0, _jquery2.default)('#input').val();
...
var printLCM = function printLCM(LCM) {
  (0, _jquery2.default)("#result").text(LCM);
};
...
(0, _jquery2.default)("#label").click(function () {
  var display = (0, _jquery2.default)('#input').css('display');

  if (display != 'none') {
    (0, _jquery2.default)("#input").hide("fast");
    (0, _jquery2.default)('#numbers').text(findMinFromArr(getInput()).join(' - '));
    smallestCommons(getInput());
  } else (0, _jquery2.default)("#input").show("fast");
});
